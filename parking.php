...
<body>
  ...
  <div class="bg-parking">
    ...
    <section class="find-section">
      <div class="find-bar d-flex flex-column flex-md-row align-items-center justify-content-between">
        <select class="dropdown">
          ...
          <option value="parking">Murree</option>
          <option value="Parking">Skardu</option>
          <option value="Parking">Swat</option>
        </select>
        <button class="find-button">Find Parking</button>
      </div>
    </section>
  </div>
</div>
    ...
    <h2 class="content" style="justify-content: center; text-align: center; color: rgb(10, 74, 53, 0.916);">Available Parking Spots</h2>
